...
def synastry_report_template(first_name: str = "", partner_name: str = "") -> dict[str, Any]:
    ...
    return {
        ...
        "resources": [
            {"title": "Физическая химия", "text": "2–3 предложения: как ресурс проявляется и как его поддерживать"},
            {"title": "Долгосрочный фундамент", "text": "2–3 предложения: как ресурс проявляется и как его поддерживать"},
            {"title": "Эмоциональная поддержка", "text": "2–3 предложения: как ресурс проявляется и как его поддерживать"},
            {"title": "Развитие через отношения", "text": "2–3 предложения: как ресурс проявляется и как его поддерживать"},
            {"title": "Совместное движение", "text": "2–3 предложения: как ресурс проявляется и как его поддерживать"},
            {"title": "Ощущение судьбоносности", "text": "2–3 предложения: как ресурс проявляется и как его поддерживать"},
        ],
        "risks": [
            {"title": "Давление и критика", "level": "высокий", "text": "2–3 предложения: как проявляется риск и что поможет"},
            {"title": "Разный язык любви", "level": "высокий", "text": "2–3 предложения: как проявляется риск и что поможет"},
            {"title": "Ревность и контроль", "level": "средний", "text": "2–3 предложения: как проявляется риск и что поможет"},
            {"title": "Неясность мотивов", "level": "средний", "text": "2–3 предложения: как проявляется риск и что поможет"},
            {"title": "Эмоциональное перенасыщение", "level": "высокий", "text": "2–3 предложения: как проявляется риск и что поможет"},
            {"title": "Зависимость от интенсивности", "level": "средний", "text": "2–3 предложения: как проявляется риск и что поможет"},
        ],
        "recommendations": [
